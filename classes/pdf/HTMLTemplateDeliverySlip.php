...
class HTMLTemplateDeliverySlipCore extends HTMLTemplate
{
    ...
    public function getContent()
    {
        ...
        //Variable para formatear direccion de la tienda de forma personalizada.
		$addressbluecommerce = $this->order_invoice->shop_address = OrderInvoice::getAddressBluecommerce((int) $this->order->id_shop);
        ...
        if ($this->order->id_address_delivery != $this->order->id_address_invoice) {
			...
			$formatted_delivery_address = str_replace("España","",$formatted_delivery_address);
        }
        ...
        $this->smarty->assign([
            ...
            'addressbluecommerce' => $addressbluecommerce,
        ]);
